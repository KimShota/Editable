...
export function RenderPanel({ jobId, onQuotaChange }: { jobId: string; onQuotaChange?: () => void }) {
  ...
  return (
    ...
    <div className="max-h-[calc(100vh-6rem)] overflow-y-auto overscroll-contain rounded-xl border border-[color:var(--ed-border-strong)] bg-[color:var(--ed-panel)] p-5 shadow-[0_12px_32px_rgba(10,10,12,0.18)]">
